...
<head>
  ...
  <link rel='stylesheet' href='assets/css/flickity.min.css'><!-- untuk import ke situs template -->
  ...
  <script src='assets/js/flickity.pkgd.min.js'></script> <!-- plugin flickity carousel -->
  <!-- Import untuk navbar -->
